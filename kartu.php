...
<body>
    <h1>SELAMAT KAMU BERHASIL MENJADI ANGGOTA KAMI</h1>
    <div class="certificate" id="certificate">
        <img class="logo" src="logo.png" alt="logo">
        <h2>Kartu Keanggotaan</h2>
        <p>Diberikan Kepada</p>
        <h1 id="recipientName"><?php echo $nama; ?></h1>
        <p>Selamat atas anggotaan Anda! Semoga kasih dan berkat Tuhan selalu menyertai Anda dalam perjalanan iman yang baru ini. Tuhan memberkati!</p>
        <p><strong>No: GIL/<?php echo $id_anggota; ?> | <?php echo date('d/m/Y', strtotime($diterima)); ?></strong></p>
